...
public final class NetworkPluginState {
  private final AtomicReference<NetworkPluginLifecycle> lifecycle = new AtomicReference<>(NetworkPluginLifecycle.NEW);
  ...
  private volatile String templateName = "Network";
  private volatile String dataDirectory = "";

  public NetworkPluginLifecycle getLifecycle() {
    return lifecycle.get();
  }

  public void setLifecycle(NetworkPluginLifecycle next) {
    lifecycle.set(next);
  }

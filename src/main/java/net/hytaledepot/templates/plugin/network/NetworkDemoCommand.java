...
public final class NetworkDemoCommand extends AbstractCommand {
  ...
  public NetworkDemoCommand(NetworkPluginState state, NetworkDemoService demoService, AtomicLong heartbeatTicks) {
    super("hdnetworkdemo", "Runs a demo action for the Network template.");
